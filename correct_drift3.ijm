...
Dialog.create("Drift correction on Image");
Dialog.addChoice("Image_with_drift", titles);
Dialog.addChoice("Image_to_correct", titles);
Dialog.show();

driftTitle = Dialog.getChoice();
correctTitle = Dialog.getChoice();
